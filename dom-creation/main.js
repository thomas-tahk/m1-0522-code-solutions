...
function renderPokemon(pokemon) {
  ...
  pokemonCardText.appendChild(h2Name);
  var h3PokeNum = document.createElement('h3');
  h3PokeNum.textContent = `#${pokemon.number}`;
  pokemonCardText.appendChild(h3PokeNum);
  var flavor = document.createElement('p');
  flavor.textContent = pokemon.description;
  pokemonCardText.appendChild(flavor);
  return columnThird;
}
